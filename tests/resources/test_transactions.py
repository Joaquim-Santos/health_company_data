...
class TestTransactionsResource:
    ...
    def test_get_without_filter_with_success(self, client):
        expected_data = [
            {
                'patient_id': 'PATIENT0001', 'first_name': 'VITORIA',
                'last_name': 'CARVALHO', 'date_of_birth': '1990-01-01T00:00:00',
                'pharmacy_id': 'PHARM0001', 'name': 'DROGA MAIS', 'city': 'RIBEIRAO PRETO',
                'transaction_id': 'TRAN0001', 'amount': 29.0, 'timestamp': '2022-05-01T08:00:00'
            },
            {
                'patient_id': 'PATIENT0001', 'first_name': 'VITORIA',
                'last_name': 'CARVALHO', 'date_of_birth': '1990-01-01T00:00:00',
                'pharmacy_id': 'PHARM0002', 'name': 'DROGA MAIS', 'city': 'SAO PAULO',
                'transaction_id': 'TRAN0002', 'amount': 30.5, 'timestamp': '2022-05-01T13:00:00'
            },
            {
                'patient_id': 'PATIENT0002', 'first_name': 'VITORIA',
                'last_name': 'SILVA', 'date_of_birth': '1986-07-12T00:00:00',
                'pharmacy_id': 'PHARM0003', 'name': 'DROGARIA SAO SIMAO', 'city': 'SAO PAULO',
                'transaction_id': 'TRAN0003', 'amount': 40.0, 'timestamp': '2022-05-10T08:00:00'
            }
        ]
