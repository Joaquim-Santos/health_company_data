...
from health_company_data_api.common.exceptions import MissingData, EntityNotFound, CustomerNotIdentified
...
class TestValidateRequest:
    ...
    def test_validate_request_with_missing_header(self):
        ...
        with pytest.raises(MissingData, match='Campos para autenticação do usuário não foram informados.'):
            get_value()
